...
- **HTML**: Skilled in creating responsive and user-friendly web pages using HTML, CSS, and basic JavaScript.
- **SQL**: Experienced in writing complex SQL queries, database design, and optimizing database performance.
...
- **Description**: Created a system to simplify ticket booking and record-keeping for buses and staff.
- **Technologies**: Java
